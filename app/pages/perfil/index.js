...
import FotoUser from "../../assets/imgPerfil/PerfilUser.png";
import FotoOng from "../../assets/imgPerfil/perfilOng.png";
...
function VerPerfil({ navigation }) {
	...
	switch (dadosPerfil?.TipoUsuario) {
		case "Biologo":
			imagemPerfil = FotoBiologo;
			break;
		case "ONG":
			imagemPerfil = FotoOng;
			break;
		default:
			imagemPerfil = FotoUser;
	}
		...
		<Container>
			...
			{dadosPerfil ? (
				<ViewContent>
					...
					{tipoUsuario === "Usuário Biólogo" && (
						<ViewText>
							<TextPrincipal>Registro Profissional:</TextPrincipal>
							<TextoAuxiliar>{dadosPerfil.RegistroBiologo}</TextoAuxiliar>
						</ViewText>
					)}
					{dadosPerfil.Responsavel && (
						<>
							<ViewText>
								<TextPrincipal>Contato de emergência:</TextPrincipal>
								<TextoAuxiliar>
							...
							<ViewText>
								<TextPrincipal>Número do contato:</TextPrincipal>
								<TextoAuxiliar>{dadosPerfil.Responsavel.Celular}</TextoAuxiliar>
							</ViewText>
						</>
					)}
					{dadosPerfil.Endereco && (
						<>
							<ViewText>
								...
								<TextoAuxiliar>{dadosPerfil.Endereco.Cep}</TextoAuxiliar>
							</ViewText>
							<ViewText>
								<TextPrincipal>Rua:</TextPrincipal>
								<TextoAuxiliar>{dadosPerfil.Endereco.Rua}</TextoAuxiliar>
							</ViewText>
							<ViewText>
								<TextPrincipal>Cidade:</TextPrincipal>
								<TextoAuxiliar>{dadosPerfil.Endereco.Cidade}</TextoAuxiliar>
							</ViewText>
						</>
					)}
